  ...
  return (
    <>
      ...
      <div>
        ...
        >
          <h1 style={{ textAlign: "center", fontSize: "1.5em" }}>Our Values</h1>
          <br />
          <Grid
            w={"80%"}
            m={"auto"}
          ...
          >
            <GridItem w="100%" h={"200px"}>
              <Box>
                ...
                <p style={{ fontSize: "14px", textAlign: "center" }}>
                  Committed to affordable, time-saving meals that fit any
            ...
            <GridItem w="100%" h={"200px"}>
              <Box>
                ...
                <p style={{ fontSize: "14px", textAlign: "center" }}>
                  Unlocking delicious, new meal possibilities with a vast
                  chef-crafted menu.
                </p>
              </Box>
            </GridItem>
          ...
          >
            <GridItem w="100%" h={"200px"}>
              <Box>
                ...
                <p style={{ fontSize: "14px", textAlign: "center" }}>
                  Reducing food waste and ensuring CO2-offset deliveries for
                  your box.
                </p>
              </Box>
            </GridItem>
            <GridItem w="100%" h={"200px"}>
              <Box>
                ...
                <p style={{ fontSize: "14px", textAlign: "center" }}>
                  Helping each other bond over joyful cooking moments and
                  homemade meals.
                </p>
              </Box>
            </GridItem>
        ...
        <Box w="100%" bgColor={"#ECF9FF"} p="3%">
          <Center>
            ...
            >
              <GridItem>
                <img
                  src="https://img.hellofresh.com/w_1920,q_auto,f_auto,c_limit,fl_lossy/hellofresh_website/us/landing-pages/about-us/AboutUs_Image_1.png"
                  alt="cookease"
                  width="80%"
                />
              </GridItem>
              <GridItem color={"#242424"}>
                <Heading fontSize={"26px"} fontWeight={"450"}>
                  Here to Change the Way People Eat. Forever
                </Heading>
                <br />
                <p>
                  We believe everyone deserves honest, delicious food. That’s
                  why we make it super simple to prepare homecooked meals that
                  bring out our inner creator and bring us together with loved
                  ones.
                </p>
                <br />
                <p>
                  Because good food nourishes our bodies. And great food
                  nourishes happiness.
                </p>
              </GridItem>
            </Grid>
        ...
        <Box w="100%" p="3%">
          <Center>
            ...
            >
              <GridItem>
                <Heading fontSize={"28px"} fontWeight={"450"}>
                  Our Difference
                </Heading>
                <br />
                <Text fontSize="20px">
                  To us, sustainability means caring for the planet and its
                  people. That’s why we’re disrupting the traditional food
                  supply chain with our sustainable, direct-to-consumer model,
                  which reduces customers’ carbon footprint by 31% compared to
                  cooking with ingredients from a supermarket.
                </Text>
                <br />
              ...
              <GridItem ml="10%">
                <img
                  src="https://img.hellofresh.com/w_1920,q_auto,f_auto,c_limit,fl_lossy/hellofresh_website/us/landing-pages/about-us/AboutUs_Image_2.png"
                  alt="cookease"
                  width="80%"
                />
              </GridItem>
